...
- Login API is working correctly - returns JWT token and user data
- Users can be registered successfully
- The issue was likely with accessing files directly instead of through the server
